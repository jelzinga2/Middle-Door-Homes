  ...
  return (
    <main>
        ...
        <Container>
          <div className="grid gap-10 lg:grid-cols-[1fr_1.05fr] lg:items-end">
            <div>
              ...
              <div className="mt-8 grid gap-5 border-t border-[var(--mdh-line)] pt-7 sm:grid-cols-3">
      ...
      <Section className="pt-0">
        <Container>
          <div className="grid gap-8 border-y border-[var(--mdh-line)] py-10 md:grid-cols-3">
            <article>
